...
<ul class="nav nav-pills">
	...
	<li class="active"><a href="__URL__/jifei">计费策略</a></li>
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
					...
					<li>
							...
							<a href="__URL__/tcinfo" class="dropdown-toggle">
								<i class="fa fa-cog"></i>
								<span class="menu-text normal">基本套餐</span>
							...
							<ul  class="submenu">
									...
									<li>
											<a href="javascript:openapp('/jifei/index.php/Charge/TcInfo','charge_tcinfo','套餐管理');">
												<i class="fa fa-caret-right"></i>
												<span class="menu-text">套餐管理</span>
											</a>					
									</li>
										<li>
											<a href="javascript:openapp('/jifei/index.php/Charge/tcadd','charge_tcadd','添加套餐');">
												<i class="fa fa-caret-right"></i>
												<span class="menu-text">添加套餐</span>
											</a>					
									</li>
							</ul>	
					...
					<li>
							...
							<a href="#" class="dropdown-toggle">
								<i class="fa fa-cog"></i>
								<span class="menu-text normal">可选流量包</span>
								<b class="arrow fa fa-angle-right normal"></b>
								<i class="fa fa-reply back"></i>
								<span class="menu-text back">返回</span>
							...
							<ul  class="submenu">
									...
									<li>
											<a href="javascript:openapp('/jifei/index.php/Charge/llb','charge_llb','流量包');">
												<i class="fa fa-caret-right"></i>
												<span class="menu-text">流量包</span>
											</a>					
									</li>
										<li>
											<a href="javascript:openapp('/jifei/index.php/Charge/llbadd','charge_llbadd','添加流量包');">
												<i class="fa fa-caret-right"></i>
												<span class="menu-text">添加流量包</span>
											</a>					
									</li>
