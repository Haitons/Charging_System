...
<ul class="nav nav-pills">
	<li class="active"><a href="__URL__/user">用户管理</a></li>
	<li><a href="__URL__/jifei">计费策略</a></li>
	<li><a href="__URL__/yingzhang">营帐管理</a></li>
	<li><a href="__URL__/yunwei">运维管理</a></li>
	<li><a href="__URL__/quanxian">权限管理</a></li>
	<li><a href="__URL__/set">系统设置</a></li>
</ul>
</div>
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
					...
					<li>
							...
							<a href="javascript:openapp('/jifei/index.php/User/add','user_add','添加用户');">
								<i class="fa fa-cog"></i>
					...
					<li>
							...
							<a href="#" class="dropdown-toggle">
								<i class="fa fa-cog"></i>
								<span class="menu-text normal">用户详情</span>
							...
							<ul  class="submenu">
									...
									<li>
											<a href="javascript:openapp('/jifei/index.php/User/information','user_information','用户信息');">
									...
									<li>
											<a href="javascript:openapp('/jifei/index.php/User/InfoModify','user_infomodify','账号密码修改');">
												<i class="fa fa-caret-right"></i>
												<span class="menu-text">用户账号密码修改</span>
											</a>					
									</li>
							</ul>	
					...
					<li>
							...
							<a href="#" class="dropdown-toggle">
								<i class="fa fa-cog"></i>
								<span class="menu-text normal">账号管理</span>
								<b class="arrow fa fa-angle-right normal"></b>
								<i class="fa fa-reply back"></i>
								<span class="menu-text back">返回</span>
							...
							<ul  class="submenu">
									...
									<li>
											<a href="javascript:openapp('/jifei/index.php/User/zhinfo','user_zhinfo','账号信息');">
												<i class="fa fa-caret-right"></i>
									...
									<li>
											<a href="javascript:openapp('/jifei/index.php/User/TaocanChange','user_taocanchange','套餐变更查询');">
												<i class="fa fa-caret-right"></i>
												<span class="menu-text">套餐变更查询</span>
											</a>					
									</li>
									<li>
											<a href="javascript:openapp('/jifei/index.php/User/llbtjjl','user_llbtjjl','流量包添加记录');">
												<i class="fa fa-caret-right"></i>
												<span class="menu-text">流量包添加记录</span>
											</a>					
									</li>
							</ul>	
