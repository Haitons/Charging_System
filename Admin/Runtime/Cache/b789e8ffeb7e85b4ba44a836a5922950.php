...
<ul class="nav nav-pills">
	...
	<li class="active"><a href="__URL__/quanxian">权限管理</a></li>
</ul>
</div>
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
					...
					<li>
							...
							<a href="javascript:openapp('/jifei/index.php/Power/info','power_info','管理员信息');">
								<i class="fa fa-cog"></i>
						...
						<li>
							...
							<a href="javascript:openapp('/jifei/index.php/Power/add','power_add','添加管理员');">
								<i class="fa fa-cog"></i>
